//geolocation
	...
	function handle_geolocation_query(position){  
		...
		var image_url2 = "http://maps.google.com/maps/api/staticmap?sensor=false&center=" + newgps_y + "," +  
				newgps_x + "&zoom=17&size=320x200&markers=color:blue|label:S|" +  
				newgps_y + ',' + newgps_x;
		...
		jQuery(document.body).append(  
		  jQuery(document.createElement("img")).attr("src", image_url2).attr('id','map2') 
		); 
